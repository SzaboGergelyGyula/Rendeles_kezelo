...
} from '../../preload/interfaces/orderResource'

ipcMain.handle('create-order-resource', (event, args: ICreateOrderResourceArgs) => {
...
ipcMain.handle('get-all-order-resources', (event) => {
...
ipcMain.handle('update-order-resource', (event, args: IUpdateOrderResourceArgs) => {
  const { order_id, resource_id, amount } = args
...
ipcMain.handle('delete-order-resource', (event, args: IDeleteOrderResourceArgs) => {
